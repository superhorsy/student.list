...
return array(
    'App\\Config' => $baseDir . '/lib/Config.php',
    'App\\Controller' => $baseDir . '/lib/Controller.php',
    'App\\Controllers\\IndexController' => $baseDir . '/lib/controllers/IndexController.php',
    'App\\Controllers\\RegisterController' => $baseDir . '/lib/controllers/RegisterController.php',
    'App\\Controllers\\TournamentController' => $baseDir . '/lib/controllers/TournamentController.php',
    'App\\ErrorHandler' => $baseDir . '/lib/ErrorHandler.php',
    'App\\Models\\TDG' => $baseDir . '/lib/models/TDG.php',
    'App\\Router' => $baseDir . '/lib/Router.php',
    'App\\Utils' => $baseDir . '/lib/Utils.php',
    'App\\View' => $baseDir . '/lib/View.php',
    'App\\components\\EndConditions' => $baseDir . '/lib/components/EndConditions.php',
    'App\\components\\TournamentInterface' => $baseDir . '/lib/components/TournamentInterface.php',
    'App\\components\\exceptions\\TournamentException' => $baseDir . '/lib/components/exceptions/TournamentException.php',
    'App\\lib\\Arr' => $baseDir . '/lib/Arr.php',
    'App\\models\\Players' => $baseDir . '/lib/models/Players.php',
    'App\\models\\PlayersTDG' => $baseDir . '/lib/models/PlayersTDG.php',
    'App\\models\\Tournament' => $baseDir . '/lib/models/Tournament.php',
    'App\\models\\TournamentFactory' => $baseDir . '/lib/models/TournamentFactory.php',
    'App\\models\\TournamentInterregional' => $baseDir . '/lib/models/TournamentInterregional.php',
    'App\\models\\TournamentTDG' => $baseDir . '/lib/models/TournamentTDG.php',
    'App\\models\\User' => $baseDir . '/lib/models/User.php',
    'App\\models\\UserTDG' => $baseDir . '/lib/models/UserTDG.php',
    'App\\models\\tournament\\interfaces\\Toss' => $baseDir . '/lib/models/tournament/interfaces/Toss.php',
    'App\\models\\tournament\\interfaces\\TossInterregional' => $baseDir . '/lib/models/tournament/TossInterregional.php',
    'App\\tests\\PlayersTDGTest' => $baseDir . '/lib/tests/PlayersTDGTest.php',
    'App\\tests\\TournamentTDGTest' => $baseDir . '/lib/tests/TournamentTDGTest.php',
